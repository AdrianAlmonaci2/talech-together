...
var PieChartBase = /** @class */ (function (_super) {
    ...
    PieChartBase.prototype.render = function () {
        ...
        return (React.createElement("div", { className: this._classNames.root },
            ...
            React.createElement(Pie_1.Pie, { culture: culture, width: width, height: height, outerRadius: outerRadius, innerRadius: 0, data: data, colors: colors, chartTitle: chartTitle })));
    };
...
exports.PieChartBase = PieChartBase;
//# sourceMappingURL=PieChart.base.js.map