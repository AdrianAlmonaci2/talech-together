define(["require", "exports", "tslib", "../../index", "d3-scale", "@fluentui/react/lib/Utilities", "@fluentui/react-focus", "@fluentui/react/lib/Callout", "react", "../Legends/index", "../../utilities/utilities", "d3-format", "d3-time-format"], function (require, exports, tslib_1, index_1, d3_scale_1, Utilities_1, react_focus_1, Callout_1, React, index_2, utilities_1, d3_format_1, d3TimeFormat) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.HeatMapChartBase = void 0;
    var getClassNames = Utilities_1.classNamesFunction();
    var HeatMapChartBase = /** @class */ (function (_super) {
        tslib_1.__extends(HeatMapChartBase, _super);
        function HeatMapChartBase(props) {
                ...
                yAxisDataPoints.forEach(function (yAxisDataPoint, index1) {
                    ...
                    _this._dataSet[yAxisDataPoint].forEach(function (dataPointObject, index2) {
                        ...
                        var rectElement = (React.createElement("g", { key: id, role: "img", "aria-label": _this._getAriaLabel(dataPointObject), "data-is-focusable": true, fillOpacity: _this._getOpacity(dataPointObject.legend), transform: "translate(" + _this._xAxisScale(dataPointObject.x) + ", " + _this._yAxisScale(dataPointObject.y) + ")", ref: function (gElement) {
                            ...
                            React.createElement("text", { dominantBaseline: 'middle', textAnchor: 'middle', className: _this._classNames.text, transform: "translate(" + _this._xAxisScale.bandwidth() / 2 + ", " + _this._yAxisScale.bandwidth() / 2 + ")" }, utilities_1.convertToLocaleString(dataPointObject.rectText, _this.props.culture))));
            ...
            _this._createLegendBars = function () {
                ...
                return React.createElement(index_2.Legends, tslib_1.__assign({}, legendProps, { legends: legends }));
            };
            ...
            _this._getXIndex = function (value) {
                if (_this._xAxisType === utilities_1.XAxisTypes.DateAxis) {
                    return "" + value.getTime();
                }
                else if (_this._xAxisType === utilities_1.XAxisTypes.StringAxis) {
                    return value;
                }
                else if (_this._xAxisType === utilities_1.XAxisTypes.NumericAxis) {
                    return "" + value;
                }
                else {
                    return '';
            ...
            _this._getYIndex = function (value) {
                if (_this._yAxisType === utilities_1.YAxisType.DateAxis) {
                    return "" + value.getTime();
                }
                else if (_this._yAxisType === utilities_1.YAxisType.StringAxis) {
                    return value;
                }
                else if (_this._yAxisType === utilities_1.YAxisType.NumericAxis) {
                    return "" + value;
                }
                else {
                    return '';
            ...
            _this._createNewDataSet = function (data, xAxisDateFormatString, xAxisNumberFormatString, yAxisDateFormatString, yAxisNumberFormatString) {
                ...
                data.forEach(function (item) {
                    item.data.forEach(function (point) {
                        flattenData.push(tslib_1.__assign(tslib_1.__assign({}, point), { legend: item.legend }));
                    });
                });
                var yPoints = {};
                var uniqueYPoints = {};
                ...
                flattenData.forEach(function (item) {
                     ...
                     */
                    if (yPoints[posY]) {
                        yPoints[posY] = tslib_1.__spreadArray(tslib_1.__spreadArray([], yPoints[posY]), [item]);
                    }
                    else {
                        yPoints[posY] = [item];
                    }
                ...
                Object.keys(yPoints).forEach(function (item) {
                    yPoints[item]
                        .sort(function (a, b) {
                        if (_this._xAxisType === utilities_1.XAxisTypes.StringAxis) {
                            return a.x.toLowerCase() > b.x.toLowerCase() ? 1 : -1;
                        }
                        else if (_this._xAxisType === utilities_1.XAxisTypes.DateAxis) {
                        ...
                        if (_this._xAxisType === utilities_1.XAxisTypes.NumericAxis) {
                        ...
                        if (_this._yAxisType === utilities_1.YAxisType.NumericAxis) {
                            datapoint.y = _this._getStringFormattedNumber(datapoint.y, yAxisNumberFormatString);
                        }
                        if (_this._yAxisType === utilities_1.YAxisType.StringAxis) {
            ...
            _this._getXAxisDataPoints = function (points) {
                ...
                var unFormattedXAxisDataPoints = Object.keys(points).sort(function (a, b) {
                    if (_this._xAxisType === utilities_1.XAxisTypes.DateAxis || _this._xAxisType === utilities_1.XAxisTypes.NumericAxis) {
                        return +a - +b;
                    }
                    else {
            ...
            _this._getYAxisDataPoints = function (points) {
                ...
                var unFormattedYAxisDataPoints = Object.keys(points).sort(function (a, b) {
                    if (_this._yAxisType === utilities_1.YAxisType.DateAxis || _this._yAxisType === utilities_1.YAxisType.NumericAxis) {
                        return +a - +b;
                    }
                    else {
                        return a.toLowerCase() > b.toLowerCase() ? 1 : -1;
            ...
            _this._getStringFormattedNumber = function (point, formatString) {
                return d3_format_1.format(formatString || '.2~s')(+point);
            };
            ...
            _this._xAxisType = utilities_1.getTypeOfAxis(x, true);
            _this._yAxisType = utilities_1.getTypeOfAxis(y, false);
            /**
             ...
             */
            _this._createSet = Utilities_1.memoizeFunction(function (data, xDate, xNum, yDate, yNum) { return _this._createNewDataSet(data, xDate, xNum, yDate, yNum); });
            _this.state = {
                selectedLegend: '',
                activeLegend: '',
                isCalloutVisible: false,
        ...
        HeatMapChartBase.prototype.render = function () {
            ...
            var calloutProps = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ isBeakVisible: false, gapSpace: 8 }, this.props.calloutProps), { isCalloutVisible: this.state.isCalloutVisible, id: this.state.calloutId, YValue: this.state.calloutYValue, legend: this.state.calloutLegend, color: this.state.calloutTextColor, target: this.state.target, styles: this._classNames.subComponentStyles.calloutStyles, directionalHint: Callout_1.DirectionalHint.topAutoEdge, onDismiss: this._closeCallout }), utilities_1.getAccessibleDataObject(this.state.callOutAccessibilityData, 'text', false)), { preventDismissOnLostFocus: true });
            var chartHoverProps = tslib_1.__assign(tslib_1.__assign({}, (this.state.ratio && {
                ratio: this.state.ratio,
            })), { descriptionMessage: this.state.descriptionMessage });
            return (React.createElement(index_1.CartesianChart, tslib_1.__assign({}, this.props, { points: data, chartType: utilities_1.ChartTypes.HeatMapChart, xAxisType: utilities_1.XAxisTypes.StringAxis, yAxisType: utilities_1.YAxisType.StringAxis, calloutProps: calloutProps, chartHoverProps: chartHoverProps, styles: this._classNames.subComponentStyles.cartesianStyles, datasetForXAxisDomain: this._stringXAxisDataPoints, stringDatasetForYAxisDomain: this._stringYAxisDataPoints, xAxisTickCount: this._stringXAxisDataPoints.length, xAxistickSize: 0, xAxisPadding: 0.02, yAxisPadding: 0.02, svgFocusZoneProps: {
                    direction: react_focus_1.FocusZoneDirection.bidirectional,
    ...
    exports.HeatMapChartBase = HeatMapChartBase;
});
