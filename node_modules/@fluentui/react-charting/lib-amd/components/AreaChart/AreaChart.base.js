define(["require", "exports", "tslib", "react", "d3-array", "d3-selection", "d3-selection", "d3-shape", "@fluentui/react/lib/Utilities", "../../index", "@fluentui/react/lib/Utilities", "../../utilities/index", "../Legends/index", "@fluentui/react/lib/Callout"], function (require, exports, tslib_1, React, d3_array_1, d3_selection_1, d3_selection_2, d3_shape_1, Utilities_1, index_1, Utilities_2, index_2, index_3, Callout_1) {
    "use strict";
    ...
    var AreaChartBase = /** @class */ (function (_super) {
        ...
        function AreaChartBase(props) {
            ...
            _this._onRectMouseMove = function (mouseEvent) {
                ...
                var xOffset = _this._xAxisRectScale.invert(d3_selection_1.clientPoint(document.getElementById(_this._rectId), mouseEvent)[0]);
                ...
                if (d0 === undefined && d1 !== undefined) {
                    ...
                    axisType = index_2.getTypeOfAxis(lineChartData[0].data[0].x, true);
                    var x0 = void 0;
                    var point0 = void 0;
                    var point1 = void 0;
                    switch (axisType) {
                ...
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                var found = Utilities_1.find(_this._calloutPoints, function (element) {
            ...
            _this._getStackedData = function (keys, dataSet) {
                var stackedValues = d3_shape_1.stack().keys(keys)(dataSet);
                var maxOfYVal = d3_array_1.max(stackedValues[stackedValues.length - 1], function (dp) { return dp[1]; });
                var stackedData = [];
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            _this._createDataSet = function (points) {
                ...
                var colors = [];
                var opacity = [];
                var calloutPoints = index_2.calloutData(points);
                points &&
                    points.length &&
            ...
            _this._getLegendData = function (palette, points) {
                ...
                return (React.createElement(index_3.Legends, tslib_1.__assign({ legends: actions, overflowProps: _this.props.legendsOverflowProps, enabledWrapLines: _this.props.enabledLegendsWrapLines, focusZonePropsInHoverCard: _this.props.focusZonePropsForLegendsInHoverCard }, _this.props.legendProps)));
            };
            ...
            _this._drawGraph = function (containerHeight, xScale, yScale, xElement) {
                ...
                _this._stackedData.forEach(function (singleStackedData, index) {
                    ...
                    graph.push(React.createElement("g", { key: index + "-dots-" + _this._uniqueIdForGraph, d: area(singleStackedData), clipPath: "url(#clip)" }, singleStackedData.map(function (singlePoint, pointIndex) {
                        ...
                        return (React.createElement("circle", tslib_1.__assign({ key: circleId, id: circleId, "data-is-focusable": true, cx: xScale(singlePoint.xVal), cy: yScale(singlePoint.values[1]), stroke: lineColor, strokeWidth: 3, visibility: _this.state.nearestCircleToHighlight ? 'visibility' : 'hidden', fill: _this._updateCircleFillColor(xDataPoint, lineColor, circleId), onMouseOut: _this._onRectMouseOut, onMouseOver: _this._onRectMouseMove, onClick: _this._onDataPointClick.bind(_this, points[index].data[pointIndex].onDataPointClick) }, pointOptions, { r: _this._getCircleRadius(xDataPoint, circleRadius) })));
                    })));
                });
                graph.push(React.createElement("line", tslib_1.__assign({ id: _this._verticalLineId, key: _this._verticalLineId, x1: _this.state.lineXValue, y1: 0, x2: _this.state.lineXValue, y2: containerHeight, strokeWidth: 1, strokeDasharray: 5.5, stroke: lineColor, opacity: 0.5, visibility: _this.state.displayOfLine }, pointLineOptions)));
                ...
                if (!_this.props.wrapXAxisLables && _this.props.showXAxisLablesTooltip) {
                    var xAxisElement = d3_selection_2.select(xElement).call(xScale);
                    try {
                        document.getElementById(_this._tooltipId) && document.getElementById(_this._tooltipId).remove();
                        // eslint-disable-next-line no-empty
                    }
            ...
            _this._createSet = Utilities_1.memoizeFunction(function (data) { return _this._createDataSet(data.lineChartData); });
            _this.state = {
                selectedLegend: '',
                activeLegend: '',
                hoverXValue: '',
            ...
            Utilities_2.warnDeprecations(COMPONENT_NAME, props, {
                showYAxisGridLines: 'Dont use this property. Lines are drawn by default',
            });
            _this._uniqueIdForGraph = Utilities_1.getId('areaChart_');
            _this._verticalLineId = Utilities_1.getId('verticalLine_');
            _this._circleId = Utilities_1.getId('circle');
            _this._rectId = Utilities_1.getId('rectangle');
            _this._tooltipId = Utilities_1.getId('AreaChartTooltipID');
            return _this;
        }
        ...
        AreaChartBase.prototype.render = function () {
            ...
            var isXAxisDateType = index_2.getXAxisType(lineChartData);
            this._colors = colors;
            ...
            var calloutProps = tslib_1.__assign({ target: this.state.refSelected, isCalloutVisible: this.state.isCalloutVisible, directionalHint: Callout_1.DirectionalHint.topAutoEdge, YValueHover: this.state.YValueHover, hoverXValue: this.state.hoverXValue, id: "toolTip" + this._uniqueCallOutID, gapSpace: 15, isBeakVisible: false, setInitialFocus: true, onDismiss: this._closeCallout, 'data-is-focusable': true, xAxisCalloutAccessibilityData: this.state.xAxisCalloutAccessibilityData }, this.props.calloutProps);
            return (React.createElement(index_1.CartesianChart, tslib_1.__assign({}, this.props, { chartTitle: chartTitle, points: lineChartData, chartType: index_2.ChartTypes.AreaChart, calloutProps: calloutProps, legendBars: legends, isCalloutForStack: true, xAxisType: isXAxisDateType ? index_2.XAxisTypes.DateAxis : index_2.XAxisTypes.NumericAxis, tickParams: tickParams, maxOfYVal: stackedInfo.maxOfYVal, getGraphData: this._getGraphData, getmargins: this._getMargins, customizedCallout: this._getCustomizedCallout(), onChartMouseLeave: this._handleChartMouseLeave, 
