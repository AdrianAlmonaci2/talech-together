define(["require", "exports", "tslib", "react", "@fluentui/react/lib/Utilities", "./LabelLink"], function (require, exports, tslib_1, React, Utilities_1, LabelLink_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EventsAnnotation = void 0;
    var EventsAnnotation = function (props) {
        ...
        var lineDefs = props.events.map(function (e) { return (tslib_1.__assign(tslib_1.__assign({}, e), { x: props.scale(e.date) })); });
        ...
        var labelLinks = calculateLabels(lineDefs, textWidth + textPadding, axisRange[1], axisRange[0]).map(function (x, i) { return (React.createElement(LabelLink_1.LabelLink, tslib_1.__assign({ key: i }, {
            lineDefs: lineDefs,
            labelDef: x,
            textY: textY,
            textWidth: textWidth,
    ...
    exports.EventsAnnotation = EventsAnnotation;
    function calculateLabels(lineDefs, textWidth, maxX, minX) {
        ...
        var backtrack = function (currentIdx, anchor) {
            ...
            var idx = Utilities_1.findIndex(lineDefs, function (ds) { return ds.x > bd && (ds.x - textWidth >= bd || ds.x + textWidth < maxX); }, currentIdx + 1);
            if (idx === -1) {
                idx = lineDefs.length;
            }
            var aggregatedIdx = [];
