define(["require", "exports", "tslib", "react", "@fluentui/react/lib/Utilities", "../Legends/index", "@fluentui/react/lib/Callout", "@fluentui/react-focus", "../../utilities/index", "@fluentui/react"], function (require, exports, tslib_1, React, Utilities_1, index_1, Callout_1, react_focus_1, index_2, react_1) {
    ...
    var MultiStackedBarChartBase = /** @class */ (function (_super) {
        ...
        function MultiStackedBarChartBase(props) {
            ...
            _this._getLegendData = function (data, hideRatio, palette) {
                ...
                return (React.createElement(index_1.Legends, tslib_1.__assign({ legends: actions, overflowProps: _this.props.legendsOverflowProps, focusZonePropsInHoverCard: _this.props.focusZonePropsForLegendsInHoverCard, overflowText: _this.props.legendsOverflowText }, _this.props.legendProps)));
            };
    ...
    exports.MultiStackedBarChartBase = MultiStackedBarChartBase;
});
