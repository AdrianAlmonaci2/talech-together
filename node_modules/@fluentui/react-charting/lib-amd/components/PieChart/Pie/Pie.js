define(["require", "exports", "tslib", "react", "d3-shape", "d3-scale", "../Arc/Arc"], function (require, exports, tslib_1, React, shape, scale, Arc_1) {
    "use strict";
    ...
    var Pie = /** @class */ (function (_super) {
        ...
        function Pie(props) {
            ...
            _this.arcGenerator = function (d, i) {
                return (React.createElement(Arc_1.LabeledArc, { culture: _this.props.culture, key: i, data: d, innerRadius: _this.props.innerRadius, outerRadius: _this.props.outerRadius, color: "" + _this.colors(i) }));
            };
            return _this;
        }
