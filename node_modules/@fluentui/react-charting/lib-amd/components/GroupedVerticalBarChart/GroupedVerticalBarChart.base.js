define(["require", "exports", "tslib", "react", "d3-array", "d3-selection", "d3-scale", "@fluentui/react/lib/Utilities", "@fluentui/react/lib/Callout", "@fluentui/react-focus", "../../utilities/index", "../../index"], function (require, exports, tslib_1, React, d3_array_1, d3_selection_1, d3_scale_1, Utilities_1, Callout_1, react_focus_1, index_1, index_2) {
    "use strict";
    ...
    var GroupedVerticalBarChartBase = /** @class */ (function (_super) {
        ...
        function GroupedVerticalBarChartBase(props) {
            ...
            xScale1, containerHeight, xElement) {
                ...
                if (!_this.props.wrapXAxisLables && _this.props.showXAxisLablesTooltip) {
                    var xAxisElement = d3_selection_1.select(xElement).call(xScale0);
                    try {
                    ...
                    xAxisElement && index_1.tooltipOfXAxislabels(tooltipProps);
                }
            ...
            _this._createX0Scale = function (containerWidth) {
                var x0Axis = d3_scale_1.scaleBand()
            ...
            _this._getLegendData = function (points, palette) {
                ...
                return (React.createElement(index_2.Legends, tslib_1.__assign({ legends: actions, overflowProps: _this.props.legendsOverflowProps, enabledWrapLines: _this.props.enabledLegendsWrapLines, focusZonePropsInHoverCard: _this.props.focusZonePropsForLegendsInHoverCard }, _this.props.legendProps)));
            };
            ...
            _this._createSet = Utilities_1.memoizeFunction(function (data) { return _this._createDataSetOfGVBC(data); });
            _this.state = {
                color: '',
                dataForHoverCard: 0,
                isCalloutVisible: false,
            ...
            _this._tooltipId = Utilities_1.getId('GVBCTooltipId_');
            return _this;
        }
        GroupedVerticalBarChartBase.prototype.render = function () {
            ...
            this._isNumeric = index_1.getTypeOfAxis(points[0].name, true);
            var legends = this._getLegendData(points, this.props.theme.palette);
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            var yMax = d3_array_1.max(this._dataset, function (point) { return d3_array_1.max(_this._keys, function (key) { return point[key]; }); });
            this._yMax = Math.max(yMax, this.props.yMaxValue || 0);
            this._classNames = getClassNames(this.props.styles, {
                theme: this.props.theme,
                href: this.props.href,
            });
            var calloutProps = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ target: this.state.refSelected, isCalloutVisible: this.state.isCalloutVisible, directionalHint: Callout_1.DirectionalHint.topAutoEdge, id: "toolTip" + this._calloutId, gapSpace: 15, isBeakVisible: false, setInitialFocus: true, color: this.state.color, Legend: this.state.calloutLegend, XValue: this.state.xCalloutValue, YValue: this.state.yCalloutValue ? this.state.yCalloutValue : this.state.dataForHoverCard, YValueHover: this.state.YValueHover, hoverXValue: this.state.hoverXValue, onDismiss: this._closeCallout }, this.props.calloutProps), { preventDismissOnLostFocus: true }), index_1.getAccessibleDataObject(this.state.callOutAccessibilityData, 'text', false));
            var tickParams = {
                tickValues: this.props.tickValues,
                tickFormat: this.props.tickFormat,
            };
            return (React.createElement(index_2.CartesianChart, tslib_1.__assign({}, this.props, { points: this._datasetForBars, chartType: index_1.ChartTypes.GroupedVerticalBarChart, calloutProps: calloutProps, legendBars: legends, xAxisType: this._isNumeric, datasetForXAxisDomain: this._xAxisLabels, tickParams: tickParams, tickPadding: this.props.tickPadding || 5, maxOfYVal: this._yMax, svgFocusZoneProps: {
