define(["require", "exports", "tslib", "react", "@fluentui/react/lib/Utilities", "@fluentui/react/lib/Callout", "@fluentui/react-focus", "../../utilities/index", "../Legends/index"], function (require, exports, tslib_1, React, Utilities_1, Callout_1, react_focus_1, index_1, index_2) {
    "use strict";
    ...
    var CartesianChartBase = /** @class */ (function (_super) {
        ...
        function CartesianChartBase(props) {
            ...
            _this._multiValueCallout = function (calloutProps) {
                ...
                return (React.createElement("div", { className: _this._classNames.calloutContentRoot },
                    React.createElement("div", { className: _this._classNames.calloutDateTimeContainer, style: yValueHoverSubCountsExists ? { marginBottom: '11px' } : {} },
                        React.createElement("div", tslib_1.__assign({ className: _this._classNames.calloutContentX }, index_1.getAccessibleDataObject(calloutProps.xAxisCalloutAccessibilityData, 'text', false)), index_1.convertToLocaleString(calloutProps.hoverXValue, _this.props.culture))),
                    React.createElement("div", { className: _this._classNames.calloutInfoContainer, style: yValueHoverSubCountsExists ? { display: 'flex' } : {} },
                        calloutProps.YValueHover &&
                            calloutProps.YValueHover.map(function (yValue, index, yValues) {
                                ...
                                return (React.createElement("div", tslib_1.__assign({}, index_1.getAccessibleDataObject(yValue.callOutAccessibilityData, 'text', false), { key: "callout-content-" + index, style: yValueHoverSubCountsExists
            ...
            _this.idForGraph = Utilities_1.getId('chart_');
            /**
        ...
        CartesianChartBase.prototype.componentDidUpdate = function (prevProps) {
            ...
            if (!this.props.wrapXAxisLables &&
                ...
                var rotatedHeight = index_1.rotateXAxisLabels(rotateLabelProps);
        ...
        CartesianChartBase.prototype.render = function () {
            ...
            var XAxisParams = {
                domainNRangeValues: index_1.getDomainNRangeValues(points, this.margins, this.state.containerWidth, chartType, this._isRtl, this.props.xAxisType, this.props.barwidth, this.props.tickValues),
            ...
            var YAxisParams = {
                ...
                yMinMaxValues: index_1.getMinMaxOfYAxis(points, chartType),
            ...
            switch (this.props.xAxisType) {
                case index_1.XAxisTypes.NumericAxis:
                    xScale = index_1.createNumericXAxis(XAxisParams, culture);
                    break;
                case index_1.XAxisTypes.DateAxis:
                    xScale = index_1.createDateXAxis(XAxisParams, this.props.tickParams, culture, dateLocalizeOptions, timeFormatLocale, customDateTimeFormatter);
                    break;
                case index_1.XAxisTypes.StringAxis:
                    xScale = index_1.createStringXAxis(XAxisParams, this.props.tickParams, this.props.datasetForXAxisDomain, culture);
                    break;
                default:
                    xScale = index_1.createNumericXAxis(XAxisParams, culture);
            }
            ...
            if (this.props.wrapXAxisLables || this.props.showXAxisLablesTooltip) {
                ...
                var temp = xScale && index_1.createWrapOfXLabels(wrapLabelProps);
            ...
            if (this.props.yAxisType && this.props.yAxisType === index_1.YAxisType.StringAxis) {
                yScale = index_1.createStringYAxis(YAxisParams, this.props.stringDatasetForYAxisDomain, this._isRtl);
            }
            else {
                yScale = index_1.createYAxis(YAxisParams, this._isRtl, axisData);
            }
            ...
            var children = this.props.children(tslib_1.__assign(tslib_1.__assign({}, this.state), { xScale: xScale, yScale: yScale }));
            var focusDirection;
            ...
            return (React.createElement("div", { id: this.idForGraph, className: this._classNames.root, role: 'presentation', ref: function (rootElem) { return (_this.chartContainer = rootElem); }, onMouseLeave: this.props.onChartMouseLeave },
                React.createElement(react_focus_1.FocusZone, tslib_1.__assign({ direction: focusDirection }, svgFocusZoneProps),
                    React.createElement("svg", tslib_1.__assign({ width: svgDimensions.width, height: svgDimensions.height, "aria-label": this.props.chartTitle, style: { display: 'block' } }, svgProps),
                ...
                React.createElement(Callout_1.Callout, tslib_1.__assign({ hidden: !(!this.props.hideTooltip && calloutProps.isCalloutVisible), 
                    ...
                    !this.props.customizedCallout && !this.props.isCalloutForStack && (React.createElement(index_1.ChartHoverCard, tslib_1.__assign({ XValue: calloutProps.XValue, Legend: calloutProps.legend, YValue: calloutProps.YValue, color: calloutProps.color, culture: this.props.culture }, chartHoverProps))))));
        };
        ...
        CartesianChartBase.prototype._getCalloutContent = function (xValue, index, yValueHoverSubCountsExists, isLast) {
            ...
            var yValue = index_1.convertToLocaleString(xValue.y, culture);
                    ...
                    React.createElement("div", { id: index + "_" + xValue.y, className: _classNames.calloutBlockContainer },
                        ...
                        React.createElement("div", null,
                            React.createElement("div", { className: _classNames.calloutlegendText },
                                " ",
                                xValue.legend),
                            React.createElement("div", { className: _classNames.calloutContentY }, index_1.convertToLocaleString(xValue.yAxisCalloutData ? xValue.yAxisCalloutData : xValue.y || xValue.data, culture))))));
            }
            else {
                ...
                return (React.createElement("div", { style: marginStyle },
                    ...
                    Object.keys(subcounts_1).map(function (subcountName) {
                        return (React.createElement("div", { key: subcountName, className: _classNames.calloutBlockContainer },
                            React.createElement("div", { className: _classNames.calloutlegendText },
                                " ",
                                index_1.convertToLocaleString(subcountName, culture)),
                            React.createElement("div", { className: _classNames.calloutContentY }, index_1.convertToLocaleString(subcounts_1[subcountName], culture))));
                    })));
            }
        };
        /**
    ...
    exports.CartesianChartBase = CartesianChartBase;
});
