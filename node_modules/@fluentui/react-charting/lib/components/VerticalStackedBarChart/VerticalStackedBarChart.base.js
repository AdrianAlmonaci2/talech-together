...
import { ChartTypes, getAccessibleDataObject, XAxisTypes, getTypeOfAxis, tooltipOfXAxislabels, } from '../../utilities/index';
...
var VerticalStackedBarChartBase = /** @class */ (function (_super) {
    ...
    function VerticalStackedBarChartBase(props) {
        ...
        _this._createLines = function (xScale, yScale, containerHeight, containerWidth) {
            var _a;
            var isNumeric = _this._xAxisType === XAxisTypes.NumericAxis;
            ...
            Object.keys(lineObject).forEach(function (item, index) {
                ...
                for (var i = 1; i < lineObject[item].length; i++) {
                    ...
                    lines.push(React.createElement("line", __assign({ key: index + "-" + i + "-line", x1: x1, y1: y1, x2: x2, y2: y2, opacity: shouldHighlight ? 1 : 0.1, strokeWidth: 3, strokeLinecap: "round", stroke: lineObject[item][i].color, transform: "translate(" + xScaleBandwidthTranslate + ", 0)" }, (_this.state.selectedLegend === item && {
            ...
            Object.keys(lineObject).forEach(function (item, index) {
                lineObject[item].forEach(function (circlePoint, subIndex) {
                    dots.push(React.createElement("circle", __assign({ key: index + "-" + subIndex + "-dot", cx: isNumeric
        ...
        xBarScale, yBarScale, containerHeight, xElement) {
            ...
            var bars = _this._points.map(function (singleChartData, indexNumber) {
                ...
                var singleBar = barsToDisplay.map(function (point, index) {
                    ...
                    var xScaleBandwidthTranslate = _this._xAxisType === XAxisTypes.NumericAxis ? 0 : xBarScale.bandwidth() / 2;
                    // If set, apply the corner radius to the top of the final bar
                    if (barCornerRadius && barHeight > barCornerRadius && index === barsToDisplay.length - 1) {
                        return (React.createElement("path", __assign({ key: index + indexNumber + ("" + shouldFocusWholeStack), className: classNames.opacityChangeOnHover, d: "\n                M " + xPoint + " " + (yPoint + barCornerRadius) + "\n                a " + barCornerRadius + " " + barCornerRadius + " 0 0 1 " + barCornerRadius + " " + -barCornerRadius + "\n                h " + (_this._barWidth - 2 * barCornerRadius) + "\n                a " + barCornerRadius + " " + barCornerRadius + " 0 0 1 " + barCornerRadius + " " + barCornerRadius + "\n                v " + (barHeight - barCornerRadius) + "\n                h " + -_this._barWidth + "\n                z\n              ", fill: color, ref: function (e) { return (ref.refElement = e); }, transform: "translate(" + xScaleBandwidthTranslate + ", 0)" }, rectFocusProps)));
                    }
                    if (barHeight < 1) {
                        return React.createElement(React.Fragment, { key: index + indexNumber }, " ");
                    }
                    return (React.createElement("rect", __assign({ key: index + indexNumber, className: classNames.opacityChangeOnHover, x: xPoint, y: yPoint, width: _this._barWidth, height: barHeight, fill: color, ref: function (e) { return (ref.refElement = e); } }, rectFocusProps, { role: "img", transform: "translate(" + xScaleBandwidthTranslate + ", 0)" })));
                });
                var groupRef = {};
                ...
                return (React.createElement("g", __assign({ key: indexNumber + ("" + shouldFocusWholeStack), id: indexNumber + "-singleBar", ref: function (e) { return (groupRef.refElement = e); } }, stackFocusProps), singleBar));
            });
    ...
    VerticalStackedBarChartBase.prototype._onStackHoverFocus = function (stack, refSelected) {
        ...
        this.setState({
            ...
            YValueHover: isLinesPresent
                ? __spreadArray(__spreadArray([], lineData.sort(function (a, b) { return (a.data < b.data ? 1 : -1); })), stack.chartData.slice().reverse()) : stack.chartData.slice().reverse(),
