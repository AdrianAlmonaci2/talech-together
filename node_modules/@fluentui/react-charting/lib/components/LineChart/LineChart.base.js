...
var LineChartBase = /** @class */ (function (_super) {
    ...
    function LineChartBase(props) {
        ...
        _this_1._onMouseOverLargeDataset = function (linenumber, lineHeight, mouseEvent) {
            ...
            var xOffset = _this_1._xAxisScale.invert(clientPoint(document.getElementById(_this_1._rectId), mouseEvent)[0]);
            ...
            if (found && pointToHighlightUpdated) {
                ...
                d3Select("#" + _this_1._staticHighlightCircle + "_" + linenumber)
        ...
        _this_1._rectId = getId('containerRectLD');
        _this_1._staticHighlightCircle = getId('staticHighlightCircle');
