...
var LegendsBase = /** @class */ (function (_super) {
    ...
    function LegendsBase(props) {
        ...
        _this._onRenderData = function (data) {
            ...
            return (React.createElement(FocusZone, __assign({}, (allowFocusOnLegends && { role: 'listbox', 'aria-label': 'Legends' })),
                React.createElement(OverflowSet, __assign({ items: data.primary, overflowItems: data.overflow, onRenderItem: _this._renderButton, onRenderOverflowButton: _this._renderOverflowItems }, overflowProps, { styles: __assign(__assign({}, rootStyles), overflowProps === null || overflowProps === void 0 ? void 0 : overflowProps.styles) }))));
        };
        ...
        _this._renderOverflowItems = function (legends) {
            ...
            var onHoverCardHideHandler = function () {
                ...
                var activeOverflowItem = find(legends, function (legend) { return legend.title === _this.state.activeLegend; });
