...
var VerticalBarChartBase = /** @class */ (function (_super) {
    ...
    function VerticalBarChartBase(props) {
        ...
        yScale, containerHeight, containerWidth) {
            ...
            var isNumericAxis = _this._xAxisType === XAxisTypes.NumericAxis;
        ...
        _this._renderContentForBothLineAndBars = function (point) {
            ...
            var content = YValueHover.map(function (item, index) {
                return (React.createElement(ChartHoverCard, __assign({ key: index, Legend: item.legend }, (index === 0 && { XValue: "" + (hoverXValue || item.data) }), { color: item.color, YValue: item.data || item.y, culture: _this.props.culture })));
            });
    ...
    VerticalBarChartBase.prototype.render = function () {
        ...
        var calloutProps = __assign(__assign(__assign(__assign({ isCalloutVisible: this.state.isCalloutVisible, directionalHint: DirectionalHint.topAutoEdge, id: "toolTip" + this._calloutId, target: this.state.refSelected, isBeakVisible: false }, (this._isHavingLine && {
        ...
        return (React.createElement(CartesianChart, __assign({}, this.props, { points: this._points, chartType: ChartTypes.VerticalBarChart, xAxisType: this._xAxisType, calloutProps: calloutProps, tickParams: tickParams }, (this._isHavingLine && { isCalloutForStack: true }), { legendBars: legendBars, datasetForXAxisDomain: this._xAxisLabels, barwidth: this._barWidth, focusZoneDirection: FocusZoneDirection.horizontal, customizedCallout: this._getCustomizedCallout(), getmargins: this._getMargins, getGraphData: this._getGraphData, getAxisData: this._getAxisData, onChartMouseLeave: this._handleChartMouseLeave, 
